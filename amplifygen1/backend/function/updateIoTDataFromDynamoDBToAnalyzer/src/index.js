// Rich fixed csrm->crsm on 12/14/24
    ...
    try {
        ...
        for (const record of event.Records) {
            ...
            if (record.eventName === 'INSERT' || record.eventName === 'MODIFY') {
                ...
                const options = newImage.options.S;
                ...
                const crsm = newImage?.crsm?.S || "0";

                // Log the extracted values
                console.log('Extracted values:', {
                    analyzerId, serialNumber, deviceStatus, owner, options, firmwareVersion, hardwareVersion, createdAt, updatedAt, crsm
                });
			    ...
			    UpdateExpression: 'set serial_number = :serialNumber, options = :options, fw_ver = :firmwareVersion, hw_ver = :hardwareVersion, createdAt = :createdAt, updatedAt = :updatedAt, crsm = :crsm',
                        ExpressionAttributeValues: {
