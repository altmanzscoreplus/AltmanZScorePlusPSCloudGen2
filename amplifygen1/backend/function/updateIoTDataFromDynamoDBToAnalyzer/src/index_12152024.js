	    ...
	    console.log('New event');
            ...
            if (record.eventName === 'INSERT' || record.eventName === 'MODIFY') {
                ...
                console.log('Extracted values:', {
                    analyzerId, serialNumber, deviceStatus, owner, options, firmwareVersion, hardwareVersion, createdAt, updatedAt, csrm
                });
			    ...
			    UpdateExpression: 'set serial_number = :serialNumber, options = :options, fw_ver = :firmwareVersion, hw_ver = :hardwareVersion, createdAt = :createdAt, updatedAt = :updatedAt, csrm = :csrm',
                        ExpressionAttributeValues: {
