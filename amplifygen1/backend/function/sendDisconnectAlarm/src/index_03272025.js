...
exports.handler = async (event) => {
    ...
    for (const record of event.Records) {
        ...
        const disconnectTime = newImage.disconnect_time/1000.0; //disconnect_time is in milli-seconds
        ...
        let adminAlarm = await getAdminAlarmInterval(deviceData.device_type);
...
async function getDeviceData(deviceId) {
    let gatewayParams = {
        ...
        IndexName: "byGatewayBycsrm",
        KeyConditionExpression: "csrm = :deviceId",
