	    ...
	    console.log('New event');
            ...
            if (record.eventName === 'INSERT' || record.eventName === 'MODIFY') {
                ...
                console.log('Extracted values:', {
                    analyzerId, serialNumber, deviceStatus, owner, options, firmwareVersion, hardwareVersion, createdAt, updatedAt
                });
                ...
                if (analyzerData.Items.length > 0) {
                    ...
                    await dynamoDB.update({
                        ...
                        UpdateExpression: 'set serial_number = :serialNumber, options = :options, fw_ver = :firmwareVersion, hw_ver = :hardwareVersion, createdAt = :createdAt, updatedAt = :updatedAt',
                        ExpressionAttributeValues: {
