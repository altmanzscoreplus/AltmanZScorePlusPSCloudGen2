        ...
        for (const record of event.Records) {
            ...
            if (record.eventName === 'INSERT' || record.eventName === 'MODIFY') {
                ...
                console.log('Extracted values:', {
                    gatewayId, serialNumber, firmwareVersion, hardwareVersion, createdAt, updatedAt
                ...
                if (gatewayData.Items.length > 0) {
                    ...
                    await dynamoDB.update({
                        ...
                        UpdateExpression: 'set serial_number = :serialNumber, fw_ver = :firmwareVersion, hw_ver = :hardwareVersion, createdAt = :createdAt, updatedAt = :updatedAt',
                        ExpressionAttributeValues: {
