...
exports.handler = async (event) => {
	...
	// Delete data from Customer Table
		...
		console.log('deleting customer record');
			...
			updateGatewayStatus(body.customerId,tableSuffix);
                	console.log(`Updated Gateway allocation status, assignment status and customer_id`);
			updateAnalyzerStatus(body.customerId,tableSuffix);
  ...
  try {
    ...
    for (const item of items) {
      const updateParams = {
        ...
        UpdateExpression: 'SET allocated_unallocated_status = :unallocated, assigned_unassigned_status = :unassigned, customer_id = :null',
        ExpressionAttributeValues: {
